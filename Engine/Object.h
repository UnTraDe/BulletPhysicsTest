...
public:
	...
	glm::vec3 GetPosition() { mMotionState->getWorldTransform(transform); return glm::vec3(transform.getOrigin().getX(), transform.getOrigin().getY(), transform.getOrigin().getZ()); };
